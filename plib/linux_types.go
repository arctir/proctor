...
//
// It is not recommended you create a LinuxInspector directly, instead use the
...
type LinuxInspector struct {
	// Holds the configuration that was generated by user, defaults, or a
	// combination of both.
	InspectorConfig
	ps           Processes
...
// creating an [Inspector] using [NewInspector]. This config should be embedded
// into a the [InspectorConfig] struct as the OSSpecificConfig value.
